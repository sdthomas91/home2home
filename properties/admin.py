...
class PropertyAdminForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields[
            'host'
            ].queryset = User.objects.filter(profile__user_type='Host')
        self.fields[
            'host'
            ].label_from_instance = (
                lambda obj: f"{obj.username} ({obj.profile.bio})"
                )
...
class PropertyAdmin(admin.ModelAdmin):
    ...
    # Enables sorting by host's username
    get_host_name.admin_order_field = 'host__username'
