...
if 'DEVELOPMENT' in os.environ:
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
    DEFAULT_FROM_EMAIL = 'samueldthomas91@gmail.com'
else:
    ...
    EMAIL_OAUTH2_CLIENT_ID = os.environ.get('OAUTH_CLIENT_ID')
    EMAIL_OAUTH2_CLIENT_SECRET = os.environ.get('OAUTH_CLIENT_SECRET')
    EMAIL_OAUTH2_REFRESH_TOKEN = os.environ.get('OAUTH_REFRESH_TOKEN')
