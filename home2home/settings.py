...
if 'DEVELOPMENT' in os.environ:
    ...
    EMAIL_OAUTH2_CLIENT_ID = os.getenv('OAUTH_CLIENT_ID')
    EMAIL_OAUTH2_CLIENT_SECRET = os.getenv('OAUTH_CLIENT_SECRET')
    EMAIL_OAUTH2_REFRESH_TOKEN = os.getenv('OAUTH_REFRESH_TOKEN')
